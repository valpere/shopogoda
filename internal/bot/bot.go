...
import (
	...
	"github.com/valpere/enterprise-weather-bot/internal/handlers/commands"
	"github.com/valpere/enterprise-weather-bot/internal/middleware"
...
func (b *Bot) Start(ctx context.Context) error {
	b.logger.Info().Msg("Starting Enterprise Weather Bot...")
